...
export class CalendarController {
  ...
  static dispatchRender() {
    ...
    if (state.calendarMode === "month") {
      container.innerHTML = renderMonthGrid(this.currentDate, activeTasks);
      ...
      container.innerHTML = renderDayList(this.currentDate, activeTasks);
    } else {
      container.innerHTML = renderYearHeatmap(this.currentDate, activeTasks);
