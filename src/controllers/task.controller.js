  ...
  bindStaticEvents() {
    ...
    if (searchInput) {
      ...
      searchInput.addEventListener("input", (e) => {
        GlobalLoaderService.show("Searching tasks...");
    ...
    activeBtn?.addEventListener("click", () =>
      handleTabClick("active", "Switching to Active Tasks..."),
    );
    completedBtn?.addEventListener("click", () =>
      handleTabClick("completed", "Loading Completed Tasks..."),
    );
    ...
    taskListContainer?.addEventListener("click", (e) => {
      ...
      const chevron = toggleBtn.querySelector(".subtask-chevron");
