export const InfoModalComponent = {
  render() {
    return `
      <div
        id="help-modal"
        class="min-h-screen fixed inset-0 z-50 hidden items-center justify-center animate-fade-in p-4 sm:p-6"
      >
        <div
        ...
        <div
          class="relative w-full max-w-2xl bg-surface border border-border rounded-3xl p-6 sm:p-8 shadow-2xl transition-all scale-95 flex flex-col max-h-[85vh] h-160"
        >
          <div
            class="flex justify-between items-center mb-5 border-b border-border pb-4 shrink-0"
          >
            <div class="flex items-center gap-2.5">
              <div
                class="w-11 h-11 rounded-xl bg-brand/10 text-brand/80 flex items-center justify-center text-2xl shrink-0"
              >
              ...
              <div>
                ...
                <p class="text-xs text-secondary w-100">
          ...
          <div
            class="flex border-b border-border/60 p-1 bg-surface-2 rounded-xl mb-5 shrink-0 gap-1"
          >
            <button
              id="tab-help-safeguard"
              class="flex-1 text-center py-2.5 text-xs sm:text-sm font-bold rounded-lg bg-brand/30 text-primary border border-brand/40 transition cursor-pointer"
            >
              <i class="fa-regular fa-list-check me-1.5"></i> Task Guide
            </button>
            <button
              id="tab-help-shortcuts"
              class="flex-1 text-center py-2.5 text-xs sm:text-sm font-bold rounded-lg text-secondary hover:text-primary transition cursor-pointer"
            >
          ...
          <div
            class="flex-1 overflow-y-auto pr-2 scroll-smooth scrollbar-thin scrollbar-thumb-surface-2 min-h-0"
          ...
          >
            ...
            >
              <div class="p-4 bg-brand/5 border border-brand/10 rounded-2xl">
                <h4
              ...
              <div
                class="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl"
              >
                <h4
              ...
              <div
                class="p-4 bg-amber-500/5 border border-amber-500/10 rounded-2xl"
              >
                <h4
            ...
            <div
              ...
              class="hidden space-y-3 overflow-y-auto pr-1"
            >
              <div
              ...
              <div
                class="flex items-center justify-between p-3 bg-surface-2/60 border border-border/50 rounded-xl hover:border-border transition"
              >
                <span
                  class="text-xs sm:text-sm font-semibold text-secondary flex items-center gap-2.5"
                >
                ...
                <div class="flex items-center gap-1">
                  <kbd
                    class="px-2 py-1 text-[10px] sm:text-xs font-mono font-bold text-primary bg-surface border border-border shadow-2xs rounded-md"
                    >Shift</kbd
                  >
          ...
          <div
            class="flex justify-end mt-4 shrink-0 border-t border-border pt-4"
          >
            <button
              id="btn-close-help"
              class="px-6 py-2.5 text-xs sm:text-sm rounded-xl bg-brand/80 text-white font-semibold hover:bg-(--color-brand-hover) transition cursor-pointer shadow-lg shadow-brand/10"
            >
              Got it, Thanks!
            </button>
          </div>
